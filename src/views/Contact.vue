  ...
  <div>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="https://www.linkedin.com/in/rafael-prates-70260724b/" target="_blank">linkedin.com/in/rafael-prates-70260724b/</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/squeakyrino" target="_blank">github.com/squeakyrino</a>
      </li>
      <!--
      <li>
